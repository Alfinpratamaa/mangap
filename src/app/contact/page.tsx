...
const ContactPage = () => {
    return (
        <div>
            <section className="bg-gray-50 dark:bg-secondary">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <form action="#" className="space-y-8">
                        ...
                        <div className="flex gap-3 items-center">
                            <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white dark:bg-black dark:text-white rounded-lg bg-primary sm:w-fit hover:opacity-70 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                            <p className="text-md text-gray-600 dark:text-white">or connect with</p>

                            <a href="https://github.com/Alfinpratamaa" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
