...
let keywordsCache: Set<string> = new Set(predefinedKeywords);

export async function updateKeywords(): Promise<void> {
  let page = 1;
  ...
  keywordsCache = newKeywords;

  console.log("Keywords updated:", Array.from(keywordsCache));
}

export async function getKeywords(): Promise<string[]> {
  return Array.from(keywordsCache);
}
